                    ...
                    <div class="row wrap-filter flex-w bg6 w-full p-l-40 p-t-27 p-lr-15-sm">
                        ...
                        <div class="col-md-12 col-sm-4 col-12 filter-col2 p-r-15 p-b-27">
                            ...
                            <ul>
                                <li class="p-b-6">
                                    <a href="#"
                                        class="filter-link stext-106 trans-04 <?php echo isset($_GET['page']) ? "filter-link-active" : ""; ?>">
                                        All
                                    </a>
                                </li>
                                <li class="p-b-6">
                                    <a href="?sort=50"
                                        class="filter-link stext-106 trans-04 <?php echo isset($_GET['sort']) && $_GET['sort'] == 50 ? "filter-link-active" : ""; ?>">
                                        $0.00 - $50.00
                                    </a>
                                </li>
                                <li class="p-b-6">
                                    <a href="?sort=100"
                                        class="filter-link stext-106 trans-04 <?php echo isset($_GET['sort']) && $_GET['sort'] == 100 ? "filter-link-active" : ""; ?>">
                                        $50.00 - $100.00
                                    </a>
                                </li>
                                <li class="p-b-6">
                                    <a href="?sort=150"
                                        class="filter-link stext-106 trans-04 <?php echo isset($_GET['sort']) && $_GET['sort'] == 150 ? "filter-link-active" : ""; ?>">
                                        $100.00 - $150.00
                                    </a>
                                </li>
                                <li class="p-b-6">
                                    <a href="?sort=200"
                                        class="filter-link stext-106 trans-04 <?php echo isset($_GET['sort']) && $_GET['sort'] === '200' ? "filter-link-active" : ""; ?>">
                                        $150.00 - $200.00
                                    </a>
                                </li>
                                <li class="p-b-6">
                        ...
                        <div class="col-md-12 col-sm-4 col-12 filter-col3 p-b-27">
                            ...
                            <div class="flex-w p-t-4 m-r--5">
                                ...
                                <a href="?sort=category&id=<?php echo $value['category_id']; ?>"
                    ...
                    <a href="product-detail.php?id=<?php echo $val['product_id']; ?>">
                        ...
                        <div class="block2-pic hov-img0 label-new" data-label="New">
                            ...
                            <div class="block2-pic hov-img0">
                                ...
                                <div
                                    style="width:15%;height:5vh;border-radius:50px;background-color:red;text-align:center;position:absolute ;padding-top:10px;color:white;font-weight:bold">
                                    50% </div>
                                <?php } ?>
                                <img src="<?php echo 'admin/' . $val['product_main_image']; ?>" loading="lazy"
                                    alt="IMG-PRODUCT">
                            </div>
